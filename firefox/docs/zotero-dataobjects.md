...
Book Title
Dictionary Title
Encyclopedia Title The title of the book, encyclopedia, or dictionary that a chapter, entry, or other book section is published in.
...
Institution
University The institution publishing a report or the university granting the degree for a thesis.
...
Conference Name
Meeting Name The name of the conference or meeting where a conference paper or presentation was presented.
...
Format
File Type The format of an audio or video recording (e.g. “DVD,” “CD,” “MP3,” etc.).
...
Fields for Websites
Website Title
Blog Title The title of the blog or website containing a post or specific web page.
...
Creator types marked with an asterisk (_) cannot be used in citations.
...
Contributor_ Other individuals or entities associated with a work that should not be included in citations (e.g., individuals listed after “with” on a book's cover). Used as the author for Hearing items.
